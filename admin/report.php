				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><?php if ($fetch['status'] == 0 )echo "<div class='btn btn-primary'>Pending</div>"; if($fetch['status'] == 1)echo "<div class='btn btn-success'>Check In</div>"; if($fetch['status'] == 2)echo "<div class='btn btn-danger'>Check Out</div>"; ?></center></td>
						</tr>
						<?php
							}
						?>
