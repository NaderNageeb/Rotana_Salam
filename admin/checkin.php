		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `room` WHERE `status` = 1 ") or die(mysqli_query());
						...
						<tr>
							...
							<td><?php echo "SDG. ".$fetch['bill'].".00"?></td>
							<td><center><a class = "btn btn-warning" href = "checkin.php?transaction_id=<?php echo $fetch['transaction_id']?>&room_id=<?php echo $fetch['room_id'] ;    ?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Check Out</a></center></td>
						</tr>
						<?php
							}
						?>
