	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Detils</div>
				<?php
				...
				<form method = "POST" enctype = "multipart/form-data" action = "">
					...
					<input type = "text" value = "<?php echo $fetch['room_id']?>"     name="room_id" class = "form-control" size = "40" disabled = "disabled"/>
					<input type = "text" value = "<?php echo $fetch['transaction_id']?>" name="trans_id" class = "form-control" size = "40" disabled = "disabled"/>
					...
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Days</label>
						<br />
						<input type = "number"  readonly value = "<?php echo $fetch['days']?>" name = "days" class = "form-control" required = "required"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Total Bill</label>
						<br />
						<input type = "number" value = "<?php echo $fetch['bill']?>" readonly name = "extra_bed" class = "form-control"/>
					</div>
